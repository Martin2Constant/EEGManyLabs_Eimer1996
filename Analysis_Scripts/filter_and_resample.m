function filter_and_resample(participant_nr, filepath, team)
    ...
    switch team
        case 'Munich'
            ...
            % Then checks whether M1 or M2 are flat for more than 30 seconds.
        ...
        case 'Essex'
            ...
            % Temporary rereference to CZ, so that we can rereference to average mastoids later.
