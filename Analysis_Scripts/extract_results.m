function extract_results(filepath, team, pipeline, participant_list)
    ...
    elseif pipeline == "Resample" || pipeline == "ICA+Resample"
        ...
        if median_pval_letters <= 0.02
            bootstrap_letters_null = 'rejected';
        else
            bootstrap_letters_null = 'not rejected';
        end
    ...
    mean_amplitudes_table = table(letters_contra_amp, letters_ipsi_amp, ...
        colors_contra_amp, colors_ipsi_amp, ...
        letters_contra_amp - letters_ipsi_amp, colors_contra_amp - colors_ipsi_amp, ...
        'VariableNames', {'Letters_contra', 'Letters_ipsi', 'Colors_contra', 'Colors_ipsi', 'Letters_Contra-Ipsi', 'Colors_Contra-Ipsi'});
