function extract_results(filepath, team)
    ...
    interaction_output = sprintf("For the team %s, contra-ipsi letters vs. colors distractor arrays between 220 ms and 300 ms with correct responses:\n" + ...
        ...
        stats_amp_interaction.dz(1), stats_amp_interaction.dz(2), stats_amp_interaction.dz(3),...
        stats_amp_interaction.gz(1), stats_amp_interaction.gz(2), stats_amp_interaction.gz(3),...
