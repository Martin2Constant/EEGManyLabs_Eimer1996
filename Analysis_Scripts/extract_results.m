function extract_results(filepath, team)
    ...
    save(sprintf('%s%s%s%sResults%sresults_interaction.mat', filepath, filesep, team, filesep, filesep), 'mean_amps_interaction', 'between_ci_amp_interaction', 'within_ci_amp_interaction', 'stats_amp_interaction');
    ...
    writetable(mean_amplitudes_table, sprintf('%s%s%s%sResults%s%s_amplitudes_table.csv', filepath, filesep, team, filesep, filesep, team));
    ...
    time_series_table = table(GA.bindata(ERP.PO7_8_index, :, 13)', GA.bindata(ERP.PO7_8_index, :, 14)',...
        ...
        'VariableNames', {'Letters_ipsi', 'Letters_contra', 'Colors_ipsi', 'Colors_contra', 'Letters_Contra-Ipsi', 'Colors_Contra-Ipsi'});
    writetable(time_series_table, sprintf('%s%s%s%sResults%s%s_time_series_table.csv', filepath, filesep, team, filesep, filesep, team));
    ...
    interaction_fileID = fopen(sprintf('%s%s%s%sResults%sinteraction_output.txt', filepath, filesep, team, filesep, filesep), 'w');
